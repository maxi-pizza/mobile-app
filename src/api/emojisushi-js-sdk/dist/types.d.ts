...
export type IProduct = {
    ...
    additional_descriptions: Nullable<any[]>;
    additional_properties: Nullable<any[]>;
...
export type SortKey = "default" | "bestseller" | "ratings" | "latest" | "price_low" | "price_high" | "oldest";
...
export declare enum ShippingMethodCodeEnum {
    Takeaway = "takeaway",
    Courier = "courier"
}
export declare enum PaymentMethodCodeEnum {
    Cash = "cash"
}
export type Banner = {
    id: number;
...
export type IOrderProduct = {
    ...
    stackable: boolean;
    shippable: boolean;
    property_values: Nullable<any[]>;
    property_description: Nullable<any[]>;
    service_options: Nullable<any[]>;
