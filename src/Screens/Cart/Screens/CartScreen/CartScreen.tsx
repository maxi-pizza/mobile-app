...
import {cartQuery} from '../../../../components/ProductCard/ProductCard.tsx';
...
const CartScreen = ({navigation, route}: {navigation: any, route: any}) => {
  ...
  const cart = (productQueryRes?.data || []).filter((item) => ids.includes(String(item.id)));
      ...
      <View style={styles.container}>
        ...
        {ids.length > 0 ? (
            <View>
              ...
              <View style={[styles.productsWrapper, {height: ids.length === 1 ? nh(155) : nh(310)}]}>
                <ScrollView>
              ...
              <View style={styles.personCountWrapper}>
                ...
                <View style={styles.counterWrapper}>
                  <Counter
                      ...
                      onHandleMinus={() => setPersonCount(Math.max(personCount - 1, 0))}
                  />
                </View>
              </View>
