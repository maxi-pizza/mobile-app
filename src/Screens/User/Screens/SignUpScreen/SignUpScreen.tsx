      ...
      <View style={styles.container}>
        ...
        <View>
          ...
          <View style={styles.agreementWrapper}>
            <CheckBox/>
            <Text style={styles.agreementText}>Я согласен с условиями использования и обработки моих персональных данных</Text>
          </View>
          ...
          <View style={styles.textWrapper}>
            <Text style={styles.yellowText}>Уже есть аккаунт? <Text onPress={() => navigation.navigate('SignIn')} style={styles.link}>Войти</Text></Text>
          </View>
        </View>
      </View>
  );
